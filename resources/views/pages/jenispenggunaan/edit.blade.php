            ...
            <div class="col-lg-7">
                ...
                <div class="card border-0 shadow-sm p-4 rounded-3">
                    <h5 class="text-center text-primary text-uppercase fw-bold mb-4">
                        Form Edit Jenis Penggunaan
                    </h5>

                    <form action="{{ route('jenis_penggunaan.update', $jenis->jenis_id) }}"
                          method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control"
                                           ...
                                           value="{{ $jenis->nama_penggunaan }}" required>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <textarea class="form-control"
                                              name="keterangan"
                                              style="height:120px">{{ $jenis->keterangan }}</textarea>
