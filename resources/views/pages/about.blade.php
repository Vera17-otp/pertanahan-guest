            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <p class="mb-4">
                            Sistem Informasi Pertanahan ini dibuat untuk mempermudah masyarakat dalam mengakses data tanah secara digital, transparan, dan efisien.
                        </p>
                ...
                <div class="row g-5">
                    <div class="col-md-6 col-lg-4">
                        <div class="bg-primary rounded p-4">
                            <a href="{{ url('/') }}"><h1 class="text-white text-uppercase mb-3">Pertanahan</h1></a>
                            <p class="text-white mb-0">
                                Sistem ini dikembangkan untuk mendukung digitalisasi data pertanahan dan pelayanan publik yang lebih efisien.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <h6 class="section-title text-start text-primary text-uppercase mb-4">Contact</h6>
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Pekanbaru, Indonesia</p>
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>info@pertanahan.go.id</p>
                    </div>
                </div>
            </div>
        </div>
