    ...
    <div class="row g-3">
        <div class="col-md-6">
            <div class="form-floating">
                <input type="number" class="form-control" name="persil_id" value="{{ old('persil_id', $dokumen_persil->persil_id) }}" required>
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" name="jenis_dokumen" value="{{ old('jenis_dokumen', $dokumen_persil->jenis_dokumen) }}" required>
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" name="nomor" value="{{ old('nomor', $dokumen_persil->nomor) }}">
                <label>Nomor</label>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" name="keterangan" value="{{ old('keterangan', $dokumen_persil->keterangan) }}">
                <label>Keterangan</label>
            </div>
        </div>

        <div class="col-12">
            <label for="file_dokumen" class="form-label">Ganti Dokumen (Opsional)</label>
            <input type="file" name="file_dokumen" class="form-control">
            @if ($dokumen_persil->file_path)
                <p class="mt-2">File saat ini:
                    <a href="{{ asset('storage/' . $dokumen_persil->file_path) }}" target="_blank">
                        {{ basename($dokumen_persil->file_path) }}
                    </a>
                </p>
            @endif
        </div>
        ...
        <div class="col-12">
            <button class="btn btn-primary w-100 py-3" type="submit">Update Dokumen</button>
        </div>
    </div>
</form>
